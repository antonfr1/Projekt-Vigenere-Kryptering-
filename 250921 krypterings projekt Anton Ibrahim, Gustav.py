...
def lavAsciiList(string): # Etablere en funktion der laver en sting om til en liste med ascii værdier.
...
def kryptering(kryptKey,tekst): # funktion der krypterer teksten.
    ...
    return lavAsciiList(kryptedTekstString) # returner den krypterede tekst som en liste med ascii værdier.
...
if  kryptOrDekrypt == "k": # hvis brugeren vil kryptere.
    tekstList = lavAsciiList(input("hvad vil du kryptere: ")) # spørger brugeren hvad de vil kryptere og laver det om til en liste med ascii værdier.
    kryptKey = lavAsciiList(input("din personlige krypt key: ")) # spørger brugeren om deres krypterings nøgle og laver det om til en liste med ascii værdier.
