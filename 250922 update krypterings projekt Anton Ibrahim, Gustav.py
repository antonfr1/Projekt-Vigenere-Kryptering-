...
def kryptOrDekrypt(valgKryptOrDekrypt): # funktion der spørger brugeren om de vil kryptere eller dekryptere.
    kryptDone = False # laver en variabel der holder styr på om der lige er blevet krypteret.
    if  valgKryptOrDekrypt == "k": # hvis brugeren vil kryptere.
    ...
    if valgKryptOrDekrypt == "d" or kryptDone == True: # hvis brugeren vil dekryptere eller der lige er blevet krypteret.
